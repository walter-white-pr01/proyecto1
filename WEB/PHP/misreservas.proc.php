					...
					while($resA=mysqli_fetch_array($reservasA)){
						echo "<div class='tarjeta'>";
							...
							echo "<div class='opciones'>";
								echo "<a href='cancelR?idr=".$resA['id_reserva']."'><i class='fas fa-times-circle'></i></a>";
							echo "</div>";
							echo "<div>";
				...
				if(mysqli_num_rows($reservasR)>0){
					while($res=mysqli_fetch_array($reservasR)){
						echo "<div class='tarjeta'>";
							...
							echo "</div>";
							echo "<div class='opciones'>";
								echo "<a href='cancelR?idr=".$res['id_reserva']."'><i class='fas fa-times-circle'></i></a>";
							echo "</div>";
							echo "<div>";
				...
				if(mysqli_num_rows($incidencia)>0){
					...
					while($in=mysqli_fetch_array($incidencia)){
						echo "<div class='tarjeta'>";
							...
							echo "</div>";
							echo "<div class='opciones'>";
								echo "<a href='cancelR?idr=".$in['id_incidencia']."'><i class='fas fa-times-circle'></i></a>";
							echo "</div>";
							echo "<div>";
